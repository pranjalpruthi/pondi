...
const HoverGallery = () => {
  ...
  const elements = [
    ...allElements,
    { id: 4, bg: "#3b82f6", img: "/temple-building/1.webp" },
  ];
...
const Gallery = (props: { item: Element; index?: number }) => {
  return (
    ...
    >
      <img src={props.item.img} className="size-full object-cover" alt={props.item.title || 'Gallery image'} />
    </motion.div>
  );
};
