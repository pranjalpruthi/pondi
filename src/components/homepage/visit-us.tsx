...
import { MapPin, Phone, ExternalLink, Clock, Calendar, Car, Plane, Bus, Train, Info, AlertCircle, Navigation, ArrowRight, Quote, ChevronLeft, ChevronRight } from "lucide-react"
...
function QuoteSlider() {
  ...
  const prevQuote = () => {
    setIsTyping(true);
    setTimeout(() => {
      setCurrentQuoteIndex((prev) => (prev === 0 ? prabhupadaQuotes.length - 1 : prev - 1));
      setIsTyping(false);
    }, 500);
  };
  ...
  const nextQuote = () => {
    setIsTyping(true);
    setTimeout(() => {
      setCurrentQuoteIndex((prev) => (prev === prabhupadaQuotes.length - 1 ? 0 : prev + 1));
      setIsTyping(false);
    }, 500);
  };
                ...
                >
                  {!isTyping && (
                    <blockquote className="text-lg md:text-xl text-gray-700 dark:text-gray-300 italic text-center leading-relaxed px-4 sm:px-10">
                      <TypingText
                        text={prabhupadaQuotes[currentQuoteIndex].text}
                        duration={45}
                        cursor={true}
            ...
            <div className="flex flex-col sm:flex-row items-center mb-6 bg-gradient-to-r from-[#e94a9c]/5 to-[#ffc547]/5 p-4 rounded-xl w-full max-w-lg mx-auto">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-sm text-[#0a84ff] mt-1 flex items-center justify-center sm:justify-start">
                  ...
                  {prabhupadaQuotes[currentQuoteIndex].source}
                </p>
              </div>
            </div>
...
export function VisitUs() {
  ...
  const handleMapLoad = (mapType: 'airport' | 'chennaiAirport' | 'bus' | 'car') => {
    setMapsLoading(prev => ({
      ...prev,
      [mapType]: false
    }));
    ...
    <TooltipProvider>
      ...
      >
        ...
        <div className="container mx-auto z-10 relative px-4 md:px-6">
          ...
          {/* Main Content */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8 px-4 sm:px-0">
            {/* Map Section */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <Card className="overflow-hidden border border-white/20 dark:border-gray-800/20 rounded-2xl bg-white/70 dark:bg-gray-900/70 backdrop-filter backdrop-blur-xl shadow-xl h-full">
                <CardContent className="p-0 h-full flex flex-col">
                  <div className="pb-4 pt-6 px-6 md:px-8">
                    <h3 className="text-xl font-semibold mb-1 text-[#0a84ff] dark:text-[#0a84ff] flex items-center">
                  ...
                  <div className="relative flex-grow w-full min-h-[300px] sm:min-h-[350px]">
                    {/* Google Map Embed with Temple Location Pin */}
                    <div className="relative w-full h-full min-h-[300px]">
                      {/* Skeleton loading state */}
                      <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 z-0 flex items-center justify-center">
                      ...
                      <iframe 
                        ...
                        className="absolute inset-0 w-full h-full min-h-[300px] border-0 z-10"
                        allowFullScreen 
                        loading="lazy"
                        referrerPolicy="no-referrer-when-downgrade"
                      ></iframe>
                      ...
                      >
                        <RippleButton 
                          size="sm" 
                          className="bg-[#0a84ff] hover:bg-[#0077ed] shadow-lg rounded-full px-5 py-2.5 text-sm text-white dark:text-white"
                          onClick={() => window.open(templeInfo.mapsLink, '_blank')}
                          rippleClassName="bg-white/30"
                          scale={8}
                        >
                          <Navigation className="h-4 w-4 mr-2" />
              ...
              <Card className="overflow-hidden border border-white/20 dark:border-gray-800/20 rounded-2xl bg-white/70 dark:bg-gray-900/70 backdrop-filter backdrop-blur-xl shadow-xl h-full">
                <CardContent className="p-6 lg:p-8 flex flex-col h-full">
                  <div className="mb-6 flex-grow">
                    <h3 className="text-xl font-semibold mb-5 text-[#e94a9c] dark:text-[#e94a9c] flex items-center">
                      <Info className="mr-2 h-5 w-5" /> Visit Information
                    </h3>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-grow">
                          ...
                          <Tooltip>
                            <TooltipTrigger>
                              <a href={`tel:${templeInfo.phone}`} className="text-sm text-gray-700 dark:text-gray-300 hover:text-[#0a84ff] dark:hover:text-[#0a84ff] transition-colors">
                                {templeInfo.phone}
                              </a>
                            </TooltipTrigger>
                          ...
                          <Tooltip>
                            <TooltipTrigger>
                              <a href={`mailto:${templeInfo.email}`} className="text-sm block text-gray-700 dark:text-gray-300 mt-1 hover:text-[#0a84ff] dark:hover:text-[#0a84ff] transition-colors">
                                {templeInfo.email}
                              </a>
                            </TooltipTrigger>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          {templeInfo.hours.map((schedule, index) => (
                    ...
                    <Dialog>
                      ...
                      >
                        ...
                        <div className="py-4 text-center text-gray-500 dark:text-gray-400">
                          ...
                          <p>Contact us at {templeInfo.phone} for immediate assistance.</p>
                        </div>
                      </DialogContent>
                    </Dialog>
                  </div>
            ...
            <Card className="overflow-hidden border border-white/20 dark:border-gray-800/20 rounded-2xl bg-white/70 dark:bg-gray-900/70 backdrop-filter backdrop-blur-xl shadow-xl">
              <CardContent className="p-5 md:p-8">
                ...
                <Tabs defaultValue="car" className="w-full">
                  <TabsList 
                    className="w-full grid grid-cols-2 sm:grid-cols-4 mb-8 bg-gray-100/50 dark:bg-gray-800/50 p-3 rounded-xl h-auto gap-2"
                  ...
                  <TabsContent value="car" className="mt-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                      <div className="space-y-4">
                        ...
                        {transportationData.car.directions.map((direction, index) => (
                          ...
                          <div className="mt-6 bg-white/40 dark:bg-gray-800/40 backdrop-filter backdrop-blur-sm p-4 rounded-xl shadow-sm">
                            ...
                            <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">{transportationData.car.landmark}</p>
                            <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">Elevation: {transportationData.car.elevation}</p>
                      ...
                      >
                        <MapWithSkeleton 
                          src={transportationData.car.mapEmbedUrl}
                      ...
                      <Tabs defaultValue="puducherry" className="w-full">
                        ...
                        <TabsContent value="puducherry">
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              >
                                <h4 className="flex items-center font-medium text-[#e94a9c] mb-3">
                                  <Plane className="mr-2 h-5 w-5" /> {transportationData.airport.name}
                                </h4>
                                  
                                <div className="flex flex-wrap gap-2 mb-3">
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <MapPin className="h-3 w-3 mr-1" /> {transportationData.airport.distance}
                                  </Badge>
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <Clock className="h-3 w-3 mr-1" /> {transportationData.airport.travelTime}
                                  </Badge>
                                </div>
                                
                                <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                                  {transportationData.airport.description}
                                </p>
                                ...
                                <div className="bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg mt-3">
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      ...
                                      <p className="text-sm font-medium">{transportationData.airport.cost}</p>
                                    </div>
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      <p className="text-xs text-gray-500 dark:text-gray-400">Self-Drive</p>
                                      <p className="text-sm font-medium">{transportationData.airport.selfDriveCost}</p>
                                    </div>
                                  </div>
                                </div>
                              </motion.div>
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                  {transportationData.airport.taxis.map((taxi, index) => (
                            ...
                            >
                              <MapWithSkeleton 
                                src={transportationData.airport.mapEmbedUrl}
                        ...
                        <TabsContent value="chennai">
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              >
                                <h4 className="flex items-center font-medium text-[#e94a9c] mb-3">
                                  <Plane className="mr-2 h-5 w-5" /> {transportationData.chennaiAirport.name}
                                </h4>
                                
                                <div className="flex flex-wrap gap-2 mb-3">
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <MapPin className="h-3 w-3 mr-1" /> {transportationData.chennaiAirport.distance}
                                  </Badge>
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <Clock className="h-3 w-3 mr-1" /> {transportationData.chennaiAirport.travelTime}
                                  </Badge>
                                </div>
                                
                                <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                                  {transportationData.chennaiAirport.description}
                                </p>
                                ...
                                <div className="bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg mt-3">
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      <p className="text-xs text-gray-500 dark:text-gray-400">Taxi</p>
                                      <p className="text-sm font-medium">{transportationData.chennaiAirport.cost}</p>
                                    </div>
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      <p className="text-xs text-gray-500 dark:text-gray-400">Bus</p>
                                      <p className="text-sm font-medium">{transportationData.chennaiAirport.busCost}</p>
                                    </div>
                                  </div>
                                  <div className="mt-2 p-2 bg-[#0a84ff]/5 rounded-lg">
                                    <p className="text-xs">{transportationData.chennaiAirport.busService}</p>
                                  </div>
                                </div>
                              </motion.div>
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                  {transportationData.chennaiAirport.taxis.map((taxi, index) => (
                                    <div key={index} className="flex items-start bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg">
                                      <Avatar className="h-8 w-8 mr-2">
                                        <AvatarFallback className="bg-[#0a84ff]/10 text-[#0a84ff]">
                                          <Phone className="h-4 w-4" />
                            ...
                            >
                              <MapWithSkeleton 
                                src={transportationData.chennaiAirport.mapEmbedUrl}
                        ...
                        <TabsContent value="trichy">
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              >
                                <h4 className="flex items-center font-medium text-[#e94a9c] mb-3">
                                  <Plane className="mr-2 h-5 w-5" /> {transportationData.trichyAirport.name}
                                </h4>
                                
                                <div className="flex flex-wrap gap-2 mb-3">
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <MapPin className="h-3 w-3 mr-1" /> {transportationData.trichyAirport.distance}
                                  </Badge>
                                  <Badge variant="outline" className="bg-[#e94a9c]/10 border-[#e94a9c]/20 text-[#e94a9c]">
                                    <Clock className="h-3 w-3 mr-1" /> {transportationData.trichyAirport.travelTime}
                                  </Badge>
                                </div>
                                
                                <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                                  {transportationData.trichyAirport.description}
                                </p>
                                ...
                                <div className="bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg mt-3">
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      <p className="text-xs text-gray-500 dark:text-gray-400">Taxi</p>
                                      <p className="text-sm font-medium">{transportationData.trichyAirport.cost}</p>
                                    </div>
                                    <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                      <p className="text-xs text-gray-500 dark:text-gray-400">Bus</p>
                                      <p className="text-sm font-medium">{transportationData.trichyAirport.busCost}</p>
                                    </div>
                                  </div>
                                  <div className="mt-2 p-2 bg-[#0a84ff]/5 rounded-lg">
                                    <p className="text-xs">{transportationData.trichyAirport.busService}</p>
                                  </div>
                                </div>
                              </motion.div>
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                  {transportationData.trichyAirport.taxis.map((taxi, index) => (
                                    <div key={index} className="flex items-start bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg">
                                      <Avatar className="h-8 w-8 mr-2">
                                        <AvatarFallback className="bg-[#0a84ff]/10 text-[#0a84ff]">
                                          <Phone className="h-4 w-4" />
                            ...
                            >
                              <MapWithSkeleton 
                                src={transportationData.trichyAirport.mapEmbedUrl}
                                isLoading={mapsLoading.chennaiAirport}
                                onLoad={() => handleMapLoad('chennaiAirport')}
                  ...
                  <TabsContent value="bus" className="mt-6">
                          ...
                          <div className="bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg mb-4">
                            <div className="grid grid-cols-2 gap-3">
                              <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                ...
                                <p className="text-sm font-medium">{transportationData.bus.schedule.first}</p>
                              </div>
                              <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                <p className="text-xs text-gray-500 dark:text-gray-400">Last Bus</p>
                                <p className="text-sm font-medium">{transportationData.bus.schedule.last}</p>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-3">
                              <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                ...
                                <p className="text-sm font-medium">{transportationData.bus.duration}</p>
                              </div>
                              <div className="bg-white/50 dark:bg-gray-700/50 p-2 rounded-lg">
                                <p className="text-xs text-gray-500 dark:text-gray-400">Fare</p>
                                <p className="text-sm font-medium">{transportationData.bus.fare}</p>
                              </div>
                          </div>
                            
                            <div className="mt-3 p-2 bg-[#0a84ff]/10 rounded-lg">
                              <p className="text-xs font-medium text-gray-900 dark:text-white">Operator</p>
                              <p className="text-sm">{transportationData.bus.operator}</p>
                          </div>
                          </div>
                        </motion.div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-700 dark:text-gray-300">{transportationData.bus.boardingPoint}</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-700 dark:text-gray-300">{transportationData.bus.droppingPoint}</p>
                              </div>
                        </div>
                            ...
                            <div className="bg-white/30 dark:bg-gray-800/30 p-3 rounded-lg">
                              ...
                              <div className="space-y-2">
                                {transportationData.bus.busStops.map((stop, index) => (
                    ...
                    >
                      <MapWithSkeleton 
                        src={transportationData.bus.mapEmbedUrl}
                ...
                <TabsContent value="train" className="mt-6">
                  ...
                  >
                    <h4 className="flex items-center font-medium text-[#0a84ff] mb-5">
                      <Train className="mr-2 h-5 w-5" /> {transportationData.train.station}
                    </h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {transportationData.train.options.map((option, index) => (
                        <motion.div 
                          key={index}
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Prabhupada Quote Section */}
        <div className="px-4 sm:px-0">
          <QuoteSlider />
        </div>

        {/* Temple Etiquette & What to Expect Section */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <Card className="overflow-hidden border border-white/20 dark:border-gray-800/20 rounded-2xl bg-white/70 dark:bg-gray-900/70 backdrop-filter backdrop-blur-xl shadow-xl">
            <CardContent className="p-6 lg:p-8">
              <h3 className="text-xl font-semibold text-center mb-8 bg-gradient-to-r from-[#e94a9c] via-[#0a84ff] to-[#ffc547] text-transparent bg-clip-text">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-r from-[#e94a9c]/10 to-[#e94a9c]/5 dark:from-[#e94a9c]/15 dark:to-[#e94a9c]/5 p-5 rounded-2xl border border-[#e94a9c]/10"
                ...
                >
                  ...
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2.5">
                    {templeEtiquette.map((item, index) => (
                      <motion.li 
                        key={index}
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-r from-[#ffc547]/10 to-[#ffc547]/5 dark:from-[#ffc547]/15 dark:to-[#ffc547]/5 p-5 rounded-2xl border border-[#ffc547]/10"
                  whileHover={{ y: -3, transition: { duration: 0.2 } }}
                >
                  <h4 className="font-medium text-[#ffc547] mb-3 flex items-center">
                    <Clock className="h-5 w-5 mr-2" /> Daily Activities
                  </h4>
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2.5">
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#ffc547]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#ffc547]">•</span>
                      </div>
                      Mangal Aarati at 4:30 AM
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#ffc547]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#ffc547]">•</span>
                      </div>
                      Guru Puja at 7:20 AM
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#ffc547]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#ffc547]">•</span>
                      </div>
                      Bhagavatam class at 8:00 AM
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#ffc547]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#ffc547]">•</span>
                      </div>
                      Gaura Arati at 5:30 PM
                    </li>
                  </ul>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-r from-[#0a84ff]/10 to-[#0a84ff]/5 dark:from-[#0a84ff]/15 dark:to-[#0a84ff]/5 p-5 rounded-2xl border border-[#0a84ff]/10"
                  whileHover={{ y: -3, transition: { duration: 0.2 } }}
                >
                  <h4 className="font-medium text-[#0a84ff] mb-3 flex items-center">
                    <ExternalLink className="h-5 w-5 mr-2" /> Visitor Amenities
                  </h4>
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2.5">
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#0a84ff]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#0a84ff]">•</span>
                      </div>
                      Free prasadam available after aartis
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#0a84ff]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#0a84ff]">•</span>
                      </div>
                      Guided tours by devotees
                    </li>
                    <li className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-[#0a84ff]/10 flex items-center justify-center mr-2 mt-0.5">
                        <span className="text-[10px] font-medium text-[#0a84ff]">•</span>
