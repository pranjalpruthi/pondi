...
export const ShinyRotatingBorderButton = ({
  ...
  return (
    <button
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-neutral-200 p-0.5 transition-transform active:scale-95 dark:bg-neutral-600",
        className,
      )}
      type="button"
      {...props}
    >
      ...
      <span className="relative z-10 block rounded-[14px] bg-blue-50 dark:bg-blue-900/80 h-full w-full flex items-center justify-center">
        <motion.span
          animate={{
            backgroundImage: [
          ...
          className="transform-gpu bg-clip-text text-neutral-600 text-sm tracking-tighter transition-colors duration-500 dark:text-neutral-200"
          transition={{
            duration: 1,
            ease: "linear",
            repeat: Number.POSITIVE_INFINITY,
